...
public class PrimitiveMoveShooterPivotDown extends Command {
  ShooterPivot shooterPivot;

  /** Creates a new PrimitiveMoveShooterPivotUp. */
  public PrimitiveMoveShooterPivotDown() {
  ...
  public boolean isFinished() {
    return shooterPivot.getShooterPivotBottomLimitSwitch();
  }
}
